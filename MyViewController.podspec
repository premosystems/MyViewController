#
#  Be sure to run `pod spec lint MyViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    ...
    s.description  = <<-DESC
    A longer description of MyViewController in Markdown format.
    ...
    * Finally, don't worry about the indent, CocoaPods strips it!
    ...
    # Or just: s.author    = "Vincil Bishop"
    # s.authors            = { "Vincil Bishop" => "vincil.bishop@vbishop.com" }
    # s.social_media_url   = "http://twitter.com/Vincil Bishop"
    ...
    s.source       = { :git => "https://github.com/premosystems/MyViewController.git", :tag => s.version.to_s }
